var APConfig = {
  ...
  kycRequiredFields: ['billingCity', 'billingCountry', 'billingState', 'billingStreetAddress', 'billingStreetNumber', 'billingStreetType', 'billingZip', 'dob', 'email', 'fname', 'lname', 'middleName', 'telephone'],
  ...
  API_V2_URL: 'wss://api_demo2.alphapoint.com/WSGateway/',
  serversList: [
